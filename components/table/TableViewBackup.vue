...
const updatePagination = () => {
  ...
  const sliced = sortedItems.value.slice(start, start + perPage.value);
  paginatedItems.value = sliced;
      ...
      <table class="table table-hover">
        <thead>
          <tr class="cursor-pointer">
            ...
            <th
              ...
              :key="header"
              class="text-black"
              style="min-width: 150px; cursor: default"
        ...
        <tbody>
          ...
          <template v-else-if="props.error">
            <tr>
              <td :colspan="keys.length" class="text-center py-4 text-danger">
          ...
          <template v-else-if="paginatedItems.length === 0">
            <tr>
              <td :colspan="keys.length" class="text-center py-4 text-muted">
                <div class="empty-state">
                  <div class="emoji">📭</div>
          ...
          <template v-else>
            <tr v-for="(item, idx) in paginatedItems" :key="idx">
              ...
              <td
                ...
                style="max-width: 400px; cursor: default"
              >
